...
- ✅ **Week 1-2**: Write Consulate Arbitration Rules v1.0
  ...
  - Action: Publish to consulatehq.com/rules/v1.0
...
- Document API at: https://docs.consulatehq.com
...
- Developer documentation site: https://developers.consulatehq.com
...
6. **Set up docs subdomain**: https://docs.consulatehq.com
