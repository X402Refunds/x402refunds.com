...
**Charter URL**: https://consulatehq.com/w3c/aap-cg/charter  
...
```json
{
  ...
  "arbitrationClause": {
    ...
    "rules": "https://consulatehq.com/rules/v1.0"
  }
}
```
...
```json
{
  ...
  "supportedRules": [
    "https://consulatehq.com/rules/v1.0",
...
- **Consulate Arbitration Rules**: https://consulatehq.com/rules/v1.0
