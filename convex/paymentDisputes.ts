 ...
 */
// Legacy non-wallet-first payment dispute intake removed.
// Canonical filing is wallet-first via:
// - HTTP: POST /v1/refunds (convex/http.ts)
// - MCP: fileCanonicalDispute (convex/lib/canonicalDispute.ts) -> pool.cases_fileWalletPaymentDispute
