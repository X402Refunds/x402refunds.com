...
function jsonError(status: number, body: any, extraHeaders?: Record<string, string>) {
...
// GET /v1/refunds/schema
// Machine-readable schema for refund filing (agent-friendly; avoids hardcoding payload shapes).
http.route({
