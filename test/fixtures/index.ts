...
// USE_LIVE_API is true ONLY when explicitly testing against production (x402refunds.com)
// All other environments (dev, preview, youthful-orca) should run full test suite
export const USE_LIVE_API = !!process.env.API_BASE_URL && API_BASE_URL.includes('x402refunds.com');
