...
if (isBadOutput(response)) {
  ...
  // Example: "https://api.x402refunds.com/disputes/claim?vendor=did:agent:seller-123"
...
```json
{
  ...
  "headers": {
    ...
    "disputeUrl": "https://api.x402refunds.com/disputes/claim?vendor=did:agent:seller-123",
...
const sellerResponse = {
  status: 500,
  headers: {
    'X-Dispute-URL': 'https://api.x402refunds.com/disputes/claim?vendor=did:agent:openai-123',
...
**Production ready!** ✅ Deployed to `api.x402refunds.com`
