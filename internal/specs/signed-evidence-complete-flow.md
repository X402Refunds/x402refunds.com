...
```json
{
  ...
  "disputeUrl": "https://api.x402refunds.com/disputes/claim?vendor=did:agent:openai-inc-1234567890",
  "publicKey": "YWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWE=",
...
Content-Type: application/json
X-Dispute-URL: https://api.x402refunds.com/disputes/claim?vendor=did:agent:openai-inc-1234567890
X-Consulate-ADP: https://api.x402refunds.com/.well-known/adp
...
```http
POST https://api.x402refunds.com/disputes/claim?vendor=did:agent:openai-inc-1234567890
Content-Type: application/json
...
```javascript
const disputeUrl = response.headers.get('X-Dispute-URL');
// Result: "https://api.x402refunds.com/disputes/claim?vendor=did:agent:openai-inc-123"
...
```json
{
  ...
  "response": {
    "status": 500,
    "headers": {
      "disputeUrl": "https://api.x402refunds.com/disputes/claim?vendor=did:agent:...",
      "vendorDid": "did:agent:..."
    },
    "body": "..."  // ← The "bad answer"
  },
...
- ✅ **Production**: `api.x402refunds.com`
- ✅ **Tests**: 489 passing
...
### Production API
```bash
curl https://api.x402refunds.com/.well-known/adp
curl https://api.x402refunds.com/.well-known/mcp.json
```
