...
**Preview URL**: `https://x402refunds.com/opengraph-image`
...
**Live URL**: `https://x402refunds.com/sitemap.xml`
...
**Live URL**: `https://x402refunds.com/manifest.webmanifest`
...
- Contact: security@x402refunds.com
- Expires: 2025-12-31
...
4. **Configure Environment Variables** (`.env.local`):
   ```bash
   NEXT_PUBLIC_SITE_URL=https://x402refunds.com
