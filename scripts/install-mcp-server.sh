...
echo "  • x402_file_dispute - File X-402 payment dispute"
echo "  • x402_check_case_status - Check case status"
echo "  • x402_list_my_cases - List X-402 cases by Ethereum wallet (ERC-8004)"
echo ""
