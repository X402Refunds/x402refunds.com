...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* FOR DEVELOPERS */}
      <Section id="developers" className="border-b border-slate-200">
        <SectionHeading 
          title="For Developers & AI Agents" 
          description="File refund requests programmatically via our REST API."
        />
        ...
        <div className="mt-10 max-w-3xl mx-auto space-y-8">
          <div className="space-y-3">
            ...
            <CodeBlock
              language="bash"
              code="curl https://api.x402refunds.com/v1/refunds/schema"
              showCopy
            />
            <p className="text-xs text-slate-500">
              Returns a JSON Schema describing the exact request body format.{" "}
              <a 
          ...
          <div className="space-y-3">
            ...
            <CodeBlock
              language="bash"
              code={`curl -X POST https://api.x402refunds.com/v1/refunds \\
  -H "Content-Type: application/json" \\
  -d '{
    "blockchain": "base",
    "transactionHash": "0x...",
    "sellerEndpointUrl": "https://api.example.com/paid",
    "description": "API error after payment"
  }'`}
              showCopy
            />
          </div>
