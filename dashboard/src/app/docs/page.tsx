  ...
  return (
    <div>
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-16">
        <Link 
          href="https://docs.x402disputes.com/agent-integration-guide"
        ...
        <Link 
          href="https://docs.x402disputes.com/dispute-types"
      ...
      <div className="mt-16 p-8 bg-gradient-to-br from-slate-50 to-slate-100 rounded-2xl border border-slate-200">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          <a 
            href="https://docs.x402disputes.com/expert-determination-rules"
            target="_blank"
