        ...
        headers: [
          ...
          // Content Security Policy
          {
            ...
            value: [
              ...
              "connect-src 'self' https://perceptive-lyrebird-89.convex.cloud https://api.consulatehq.com https://www.google-analytics.com https://clerk.consulatehq.com https://*.clerk.accounts.dev wss://*.convex.cloud https://*.convex.cloud",
