      ...
      },
      {
        ...
        headers: [
          ...
          // Content Security Policy
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-eval' 'unsafe-inline' https://cdn.jsdelivr.net https://www.googletagmanager.com https://www.google-analytics.com https://challenges.cloudflare.com https://*.clerk.accounts.dev https://clerk.x402disputes.com https://analytics.ahrefs.com",
              ...
              "connect-src 'self' https://api.x402disputes.com https://perceptive-lyrebird-89.convex.cloud wss://perceptive-lyrebird-89.convex.cloud https://www.google-analytics.com https://*.clerk.accounts.dev https://clerk.x402disputes.com wss://*.convex.cloud https://*.convex.cloud https://analytics.ahrefs.com https://pulse.walletconnect.org https://api.web3modal.org https://*.walletconnect.com https://*.walletconnect.org wss://relay.walletconnect.com wss://relay.walletconnect.org https://*.coinbase.com https://rpc.walletconnect.org",
