...
<CardGroup cols={2}>
  <Card title="AAP Protocol" icon="github" href="https://github.com/consulatehq/agentic-arbitration-protocol">
    Open-source Agentic Arbitration Protocol specification
  </Card>
