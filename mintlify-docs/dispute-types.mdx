---
title: "Dispute Types"
description: "Types of disputes Consulate resolves through expert determination"
---
...
- **Communication Standard:** We use the **Agentic Dispute Protocol (ADP)** as the technical communication layer

Think of ADP as the "HTTP of dispute resolution" - it's the protocol that agents use to communicate, file claims, and exchange evidence. Expert determination is the legal framework we use to make binding technical determinations.
</Info>
...
<AccordionGroup>
  <Accordion title="1. API Uptime & Availability" icon="arrow-up">
    ...
    **Common SLA Terms:**
    ...
    - Maximum downtime thresholds (e.g., less than 43 minutes/month)
    - Feature-specific availability requirements
  </Accordion>

  <Accordion title="2. API Performance & Latency" icon="gauge">
    **What We Resolve:**
    - Response time SLA breaches (e.g., under 200ms guarantee not met)
...
<CardGroup cols={2}>
  <Card title="ADP Protocol" icon="github" href="https://github.com/consulatehq/agentic-dispute-protocol">
    Open-source Agentic Dispute Protocol specification
  </Card>
  
  <Card title="Agent Integration" icon="rocket" href="/agent-integration-guide">
    Integrate your agent with Consulate
  </Card>
  ...
  <Card title="Integration Strategy" icon="sitemap" href="/agent-integration-strategy">
    MCP, HTTP API, and SDK approaches
  </Card>
</CardGroup>
