---
title: "Expert Determination Rules v1.0"
description: "Published expert determination rules implementing the Agentic Dispute Protocol (ADP)"
---

**Effective Date**: October 9, 2025  
**Version**: 1.0  
**Protocol**: Agentic Dispute Protocol (ADP) - [GitHub](https://github.com/consulatehq/agentic-dispute-protocol)  
...
The Consulate Expert Determination Rules implement the Agentic Dispute Protocol (ADP) to establish a transparent, neutral, and technologically-native framework for resolving technical disputes between autonomous agents, AI systems, and enterprises in digital commerce.
...
- **Enforceability**: Determinations are cryptographically signed and legally binding under pre-agreed expert determination agreements
- **Scalability**: From micro-disputes ($10) to enterprise conflicts ($1M+)

<Note>
**Legal Framework**: Consulate implements the Agentic Dispute Protocol (ADP) using expert determination principles for technical disputes with objective metrics. Determinations are enforceable through contract law, not the Federal Arbitration Act. ADP is method-agnostic; we use expert determination as our resolution method.
</Note>
...
- All parties have agreed in writing (including digitally signed contracts) to expert determination under Consulate Rules
...
### 1.2 Jurisdiction
Consulate expert determination operates as:
- **Primary jurisdiction**: For technical disputes between AI agents with pre-agreed expert determination clauses
...
- Family law matters
- Matters requiring legal interpretation beyond technical assessment
- Matters prohibited from expert determination by applicable law
...
A claimant initiates expert determination by submitting:
...
- **Proof of expert determination agreement** (contract reference or digital signature)

### 2.2 Technical Filing Format (ADP-Compliant)
```json
{
...
- Default determinations issue within 48 hours if claim is proper
...
## Article 5: Expert Panel

### 5.1 Panel Composition

**Micro/Agentic Tier** (claims under $10K):
- Single AI expert determinator
- Human oversight review only if appealed

**SMB/API Tier** ($10K-$1M):
- 3-judge panel: 2 AI judges + 1 human expert determinator
- Human has tiebreaker authority

**Enterprise/Governance Tier** (over $1M):
- 5-judge panel: 3 AI judges + 2 human expert determinators
- Requires supermajority (3/5) for ruling

### 5.2 Expert Determinator Selection
- **Claimant** selects 1 expert determinator
- **Respondent** selects 1 expert determinator
- **System** appoints neutral chair or additional judges
- All selections from pre-vetted registry

### 5.3 Expert Determinator Qualifications
AI expert determinators must:
- Be trained on technical standards and SLA interpretation
- Have explainable decision-making (not black-box)
- Maintain 85%+ consistency with human technical expert standards (validated)
- Disclose model architecture and training data provenance

Human expert determinators must:
- Hold relevant technical certifications or equivalent domain expertise
- Have no conflict of interest
- Complete Consulate AI Expert Determination training

### 5.4 Challenge and Recusal
Any expert determinator may be challenged for:
- Demonstrable bias
- Conflict of interest
- Technical malfunction (for AI expert determinators)
...
**Fast Track** (automated, under $10K):
- Filing → Response (7 days) → Review (2 days) → Determination (1 day)
- Total: **~10 days**

**Standard Track** ($10K-$1M):
- Filing → Response (14 days) → Discovery (14 days) → Hearing (if needed, 7 days) → Deliberation (7 days) → Determination
- Total: **~42 days**

**Complex Track** (over $1M or multi-party):
- Custom timeline set by panel
- Must not exceed **90 days** from filing to determination
...
- Determinations are **public** (anonymized unless parties object)
- Precedential value requires publication

---

## Article 7: Determinations and Enforcement

### 7.1 Determination Requirements
Every determination must include:
- **Finding of facts**: What happened
- **Technical reasoning**: Why this outcome
- **Remedy**: What the losing party must do
- **Enforcement mechanism**: How to comply
- **Signature**: Cryptographic signature of all expert determinators

### 7.2 Determination Format
```json
{
  "@type": "ExpertDetermination",
  "determinationId": "det_xyz789",
  "caseId": "case_abc123",
  "issuedAt": "2025-10-20T15:00:00Z",
  "panel": ["expert_1", "expert_2", "expert_3"],
...
- **Enforceable** through contract law and specific performance remedies

<Note>
**Enforcement Mechanism**: Expert determinations are enforceable through breach of contract claims, not the Federal Arbitration Act. Enforcement typically takes 3-6 months through courts compared to 30-60 days for traditional arbitration awards.
</Note>

### 7.4 Compliance Monitoring
- Losing party must comply within **30 days** of determination
...
Appeals only for:
- **Manifest error of technical fact** (clear factual mistake)
- **Fraud or corruption** in the proceeding
- **Expert determinator misconduct** (proven bias/conflict)
- **Technical malfunction** affecting AI expert determinator decision

Appeals must be filed within **14 days** of determination.
...
### 8.2 Expert Determinator Fees

**AI Expert Determinators**: Included in filing fee (no additional charge)

**Human Expert Determinators**:
- Flat fee: $2,500 per case (standard track)
- Hourly rate: $300/hr for complex cases
- Capped at $25,000 per expert determinator per case
...
- Execute determinations promptly
...
### 9.3 Expert Determinator Code of Ethics
See separate document: **Code of Ethics for AI Expert Determinators** (Appendix A)
...
- **Primary**: Contract law principles and specific performance remedies
- **Secondary**: Applicable commercial law governing the underlying agreement
- **Procedural**: Delaware General Corporation Law (expert determination statutes)

<Note>
**Distinction from Arbitration**: Expert determinations are contract-based dispute resolution mechanisms, not arbitration under the Federal Arbitration Act. They are enforceable through breach of contract claims and specific performance remedies.
</Note>

### 11.2 Judicial Review
Determinations may be challenged in courts on limited grounds:
- Determination procured by corruption/fraud
- Evident partiality of expert determinators
- Expert determinators exceeded their contractual authority
- Expert determinators refused to hear material evidence

### 11.3 Enforcement Jurisdiction
Determinations are enforceable through contract law in any jurisdiction where the parties' agreement is valid and enforceable.

---

## Appendices

### Appendix A: Code of Ethics for AI Expert Determinators
[See separate document: `/code-of-ethics`]

### Appendix B: Evidence Format Specifications
[See separate document: `/evidence-format-spec`]

### Appendix C: Technical Protocol Reference
[See IETF Internet-Draft: Agentic Dispute Protocol]
...
**Academic citation**:
Consulate Expert Determination Rules v1.0, Consulate Standards Committee (2025), available at https://consulatehq.com/rules/v1.0

**Legal citation**:
Consulate Expert Det. R. § [Article].[Section] (v1.0 2025)

Example: Consulate Expert Det. R. § 4.1 (v1.0 2025) [Evidence admissibility standards]
